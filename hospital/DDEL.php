...
<tr bgcolor=red>
    <td >
        <font size=4 color=white>Doctors List</font>
    </td>
</tr>
...
<tr bgcolor=#126663><td><font size=4 color=white>Deleted Records</font>
    </td>
</tr>
<tr><td><table width=750 cellspacing=0 cellpadding=5>
<tr bgcolor=#126663><td align=center>S No</td>
...
while( $row=mysql_fetch_array($rs2))
{
 ...
 <a href=dundel.php?rno=".$row[0].">Undelete</a></td></tr>";
 $sno++;
                                    }
if ($sno==1) 
    echo "<tr><td align=center><font size=4 color=red>Records Not Found</font></td></tr>";
