...
{
 echo "<tr><td>$sno</td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td><a href=pmod.php?rno=".$row[0].">Modify</a> | <a href=pdel.php?rno=".$row[0].">Delete</a></td></tr>";
 $sno++;
}
if ($sno==1)
...
if ($sno==1) echo "<tr><td align=center><font size=4 color=#126663>Records Not Found</font></td></tr>";
?>
</table></td></tr>
</table>
</body>
